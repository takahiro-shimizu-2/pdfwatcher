      ...
      if (data[i][0] === pageUrl) {
        ...
        if (row[2]) {
          summary.run1 = {
            ...
            pageUpdated: row[3] as boolean,
            pdfUpdated: row[4] as boolean,
            addedCount: row[5] as number,
          };
        }
        ...
        if (row[6]) {
          summary.run2 = {
            ...
            pageUpdated: row[7] as boolean,
            pdfUpdated: row[8] as boolean,
            addedCount: row[9] as number,
          };
        }
        
        if (row[10]) {
          summary.run3 = {
            date: new Date(row[10] as string),
            pageUpdated: row[11] as boolean,
            pdfUpdated: row[12] as boolean,
            addedCount: row[13] as number,
          };
        }
